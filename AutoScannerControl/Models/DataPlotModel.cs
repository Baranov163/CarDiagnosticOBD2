...
namespace OS.AutoScanner.Models
{
    public class DataPlotModel : PlotModel
    {
        ...
        public DataPlotModel(string title)
        {
            ...
            this.Axes.Add(new LinearAxis() { Position = AxisPosition.Bottom, Minimum = 0, Maximum = 1000, Key = "Горизонталь", IsAxisVisible = false });
            this.Axes.Add(new LinearAxis() { Position = AxisPosition.Left, Minimum = 0, /* Maximum = 5, */ Key = "Вертикаль" });
